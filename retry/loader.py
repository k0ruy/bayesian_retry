...
def load_data(path_to_forlder: str):
    df = pd.concat([pd.read_csv(Path(path_to_forlder, "hockey_21-22.csv"), sep=";"),
                    pd.read_csv(Path(path_to_forlder, "hockey_15-16.csv"), sep=";"), 
                    ...
                    pd.read_csv(Path(path_to_forlder, "hockey_20-21.csv"), sep=";")], ignore_index=True)
